...
include_once("../dao/tipopercepcionDAO.php");
include_once("../dao/tipodeduccionDAO.php");
...
public function getEmpleado($noemp){
  $empleadoDAO=new EmpleadoDAO();
  return $empleadoDAO->getEmpleado($noemp);
}
...
public function gettipospercepcion(){
$tipopercepcionDAO=new TipopercepcionDAO();
return $tipopercepcionDAO->gettipospercepcion();
}

public function gettiposdeduccion(){
$tipodeduccionDAO=new TipodeduccionDAO();
return $tipodeduccionDAO->getDeducciones();
}
...
switch($request){
  ...
  break;
  case "getempleados";//optiene todos los empleados
    echo json_encode((new Factura33l())->getEmpleados());
  break;
  case "getempleado";
  ...
  break;
  case "gettiposdeduccion";
    echo json_encode((new Factura33l())->gettiposdeduccion());
  break;
  case "gettipospercepcion";
    echo json_encode((new Factura33l())->gettipospercepcion());
  break;
